...
It works as a four-level loop. Key name is in alphabhetic
order. To see how the data looks like, have a look at the
comment and the samples at each levels.
      ...
      _.forEach(b, function(c, ck) {
        ...
        _.forEach(c, function(d, dk){
          ...
          if(matches.length == 0){
            ...
            //console.log('Rd19', dk, d, value.s, key.s);  // DEBUG
          }
