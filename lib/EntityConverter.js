    ...
    _.forEach(a, function(b, bk) {
      ...
      _.forEach(b, function(c, ck) {
        ...
        _.forEach(c, function(d, dk){
          ...
          // has something after it, set to (a)lmost, move name value pair into notes
          //if(/^\(?yes\)?[\s\w].*/i.test(value) == true) {
          //  matches.push('Rd12');
          ...
          // Rewrite Rd14: (TODO)
          //
          // If has "Activated on Nightly only", set as (a)lmost, move name value pair into notes
