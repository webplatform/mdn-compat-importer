...
# Adjust your preferences in your own host system, see: http://docs.vagrantup.com/v2/vagrantfile/
...
Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder "vagrant/salt-roots/pillars",  "/srv/pillars"
  ...
  config.vm.provision :salt do |c|
    c.minion_config = "vagrant/minion.conf"
